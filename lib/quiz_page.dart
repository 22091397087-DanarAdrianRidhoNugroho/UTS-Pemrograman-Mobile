...
// Kelas QuizPage adalah StatefulWidget yang menampilkan kuis
...
class _QuizPageState extends State<QuizPage> {
  int score = 0; // Variabel untuk menyimpan score
  int currentQuestionIndex = 0; // Variabel untuk menyimpan pertanyaan
  List<Question> questions = [
    // List pertanyaan beserta opsi jawabannya
    Question(
  ...
  void checkAnswer(int selectedIndex) {
    if (selectedIndex == questions[currentQuestionIndex].correctIndex) {
      // Jika jawaban benar, tambahkan score
      setState(() {
        score++;
      });
    }
...
// Kelas Question untuk menyimpan informasi pertanyaan dan jawabannya
class Question {
  String questionText;
  List<String> options;
  int correctIndex;
